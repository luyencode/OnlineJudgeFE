<template>
  <div id="header">
    <Menu theme="light" mode="horizontal" @on-select="handleRoute" :active-name="activeMenu" :class="oj-menu">
      ...
      <!-- <div class="logo" title="Luyện lập trình"><a href="/"><img src="/static/img/logo-ny.png" height="60px" alt="Luyện lập trình tương tác trực tuyến"></a></div> -->
      <div class="logo" title="Luyện lập trình"><a href="/"><img src="/static/img/logo.png" height="60px" alt="Luyện lập trình tương tác trực tuyến"></a></div>
