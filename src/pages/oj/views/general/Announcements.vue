    ...
    <Col :span="5" v-if="!isContest" >
      ...
      <!-- <Panel shadow style="margin-top: 37px;padding-bottom: 5px;">
        ...
        <ul style="margin-left: 40px;margin-bottom: 20px;">
          ...
          <li style="padding: 5px 0px;"><a href="" class="link-style" onclick="event.preventDefault();window.open('https://discord.gg/hpeRrbccfZ', '_blank');">Luyện lập trình: Hỏi & Đáp trên Discord (😘)</a></li>
